...
export class ResponseEmbed extends RichEmbed {
	...
	constructor(data?: RichEmbedOptions) {
		...
		this.setFooter(`This was generated by B4ST10N ${app.version}`, null);
	}
	...
	public complete(success: boolean): void {
		...
		this.setFooter(`This was generated by B4ST10N ${app.version} | ${this.executionEnd - this.executionStart} ms`, null);
	}
